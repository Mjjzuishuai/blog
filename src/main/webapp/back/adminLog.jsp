...
<link rel="stylesheet" type="text/css"
      href="${pageContext.request.contextPath}/jqgrid/css/css/cupertino/jquery-ui-1.8.16.custom.css"/>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $("#pTable").jqGrid({
                    ...
                    colModel: [{name: "id"}, {name: "adminname", editable: true}, {
                        name: "date",
                        editable: true
                    ...
                    edit: true,
                    del: true
                }, {colseAfterAdd: true}, {colseAfterEdit: true});//增删改查
            });//页面加载结束
        </script>
    </head>
